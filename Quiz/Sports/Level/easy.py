...
file = open('sportsquizsheeteasy.csv', 'w', newline='')
...
def questions():
    ...
    for i in cwcyear: # Can change number of questions from here
        
        cwcwinnerfunction(i,uanswerarray,answer)
        cwchostfunction(i,uanswerarray,answer)
    for i in acyear:
        acwinnerfunction(i,uanswerarray,answer)
