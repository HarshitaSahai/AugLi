...
file = open('sportsquizsheetmedium.csv', 'w', newline='')
...
def questions():
    ...
    for i in cwcyear: # Can change number of questions from here
        ...
        cwcvenufunction(i,uanswerarray,answer)
    for i in acyear:
        achostfunction(i,uanswerarray,answer)
        acvenufunction(i,uanswerarray,answer)
