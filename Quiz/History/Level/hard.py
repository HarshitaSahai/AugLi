...
file = open('historyquizsheethard.csv', 'w', newline='')
...
df_csv1 = pd.read_csv('yeh.csv',encoding='cp1252')
hdeyear = df_csv1.iloc[0:15,0].values
hdeevents = df_csv1.iloc[0:15,1].values
hdeyearl = hdeyear.tolist()


df_csv2 = pd.read_csv('yeihard.csv',encoding='cp1252')
hdeiyear = df_csv2.iloc[0:53,0].values
hdeievents = df_csv2.iloc[0:53,1].values
hdeiimp = df_csv2.iloc[0:53,2].values
