...
file = open('historyquizsheetmedium.csv', 'w', newline='')
...
df_csv1 = pd.read_csv('yem.csv',encoding='cp1252')
hdeyear = df_csv1.iloc[0:5,0].values
hdeevents = df_csv1.iloc[0:5,1].values
hdeyearl = hdeyear.tolist()


df_csv2 = pd.read_csv('yeimedium.csv',encoding='cp1252')
hdeiyear = df_csv2.iloc[0:31,0].values
hdeievents = df_csv2.iloc[0:31,1].values
hdeiimp = df_csv2.iloc[0:31,2].values
