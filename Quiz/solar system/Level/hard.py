...
file = open('solarsystemsheethard.csv', 'w', newline='')
...
def questions(): # Function will create 5 questions randomly
   ...
   for i in pn:
       ...
       #temperature(i,uanswer,answer)
        rotation(i,uanswer,answer)
        revolution(i,uanswer,answer)
        atomcomposition(i,uanswer,answer)
        composition(i,uanswer,answer)
